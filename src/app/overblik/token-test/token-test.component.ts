...
export class TokenTestComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    else if(this.shortTokenIsFresh(new Date, new Date(this.shortLivedDate))){
    ...
    .subscribe({
      ...
      error: (e: any) => {console.log("There was an error!"); console.log(e); this.errorMessage = e},
      complete: () => {
  ...
  private getMeteringPoints() {
    ...
    .subscribe( {
      ...
      error: (e) => {console.log(`There was an error: ${e}`); this.errorMessage = e},
